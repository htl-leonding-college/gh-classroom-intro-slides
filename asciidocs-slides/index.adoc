...
* An Schüler einer Klasse benötigen oft Vorlage-Repositories zum Durchführen von Aufgaben
* Nach der Aufgabendurchführung werden diese Repositories abgesammelt
* Diese Repositories können auch öfter abgesammelt werden

== Wie

* Ein Vorlagerepository wird automatisch in die Profile
