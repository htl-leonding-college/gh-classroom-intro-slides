...
//:numbered:  // Slide-Überschriften nummerieren

== Warum

* Schüler einer Klasse benötigen oft Vorlage-Repositories zum Durchführen von Aufgaben
* Nach der Aufgabendurchführung werden diese Repositories abgesammelt
* Aucg Zwischenstände sollen abgesammelt werden können

== Wie

* Ein Vorlagerepository wird für jeden Schüler automatisch in eine github-Organisation des Lehrers kopiert
* Dabei werden die Repositories nach jedem Schüler benannt
* Die Repos können jederzeit in einen lokalen Ordner kopiert werden. Dabei erhalten Sie einen Zeitstempel
